...
The build script we'll be using is contained in the MINT github repository ([contrib/gitian-build.py](https://github.com/mintrax910/mintrax/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the MINT repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/MINT-Project/MINT/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, mintrax-detached-sigs, and mintrax GitHub repos.
