...
# Create zip file of binaries
	cp mintrax/src/mintraxd.exe mintrax/src/mintrax-cli.exe mintrax/src/mintrax-tx.exe mintrax/src/qt/mintrax-qt.exe .
	zip MINT-Windows.zip mintraxd.exe mintrax-cli.exe mintrax-tx.exe mintrax-qt.exe
	rm -f mintraxd.exe mintrax-cli.exe mintrax-tx.exe mintrax-qt.exe
