...
class ReorgStakeTest(MintraxTestFramework):
    ...
    def check_money_supply(self, expected_bib, expected_zbib):
        ...
        # verify that nodes have the expected MINT and zMINT supply
        for node in g_info:
            assert_equal(node['moneysupply'], DecimalAmt(expected_bib))
            for denom in node['zMINTsupply']:
                assert_equal(node['zMINTsupply'][denom], DecimalAmt(expected_zbib[denom]))
    ...
    def run_test(self):
        ...
        # Check MINT and zMINT supply at the beginning
        # ------------------------------------------
        # zMINT supply: 2 coins for each denomination
        ...
        # MINT supply: block rewards minus burned fees for minting
        ...
        # Verify that MINT and zMINT supplies were properly updated after the spends and reorgs
        self.log.info("Check MINT and zMINT supply...")
