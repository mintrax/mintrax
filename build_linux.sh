...
# Create zip file of binaries
	cp mintrax/src/mintraxd mintrax/src/mintrax-cli mintrax/src/mintrax-tx mintrax/src/qt/mintrax-qt .
	zip MINT-$(git describe --abbrev=0 --tags | sed s/v//)-Linux.zip mintraxd mintrax-cli mintrax-tx mintrax-qt
	rm -f mintraxd mintrax-cli mintrax-tx mintrax-qt
