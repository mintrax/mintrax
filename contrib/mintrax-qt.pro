...
RESOURCES += src/qt/mintrax.qrc src/qt/mintrax_locale.qrc

TRANSLATIONS += src/qt/locale/mintrax_bg.ts \
                src/qt/locale/mintrax_de.ts \
                src/qt/locale/mintrax_en.ts \
                src/qt/locale/mintrax_es.ts \
                src/qt/locale/mintrax_fi.ts \
                src/qt/locale/mintrax_fr.ts \
                src/qt/locale/mintrax_it.ts \
                src/qt/locale/mintrax_ja.ts \
                src/qt/locale/mintrax_pl.ts \
                src/qt/locale/mintrax_pt.ts \
                src/qt/locale/mintrax_ru.ts \
                src/qt/locale/mintrax_sk.ts \
                src/qt/locale/mintrax_sv.ts \
                src/qt/locale/mintrax_vi.ts \
                src/qt/locale/mintrax_zh_CN.ts \
                src/qt/locale/mintrax_zh_TW.ts
