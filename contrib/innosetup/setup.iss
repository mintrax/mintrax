...
#define MyAppName "MINT Core"
#define MyAppPublisher "2022 MINT Core Developers"
#define MyAppURL "https://mintrax.net"
#define MyAppExeName "mintrax-qt.exe"
#define MyAppExtraData "https://explorer.mintrax.net/bootstraps/MINT/bootstrap.zip"
...
[Files]
Source: ".\package\mintrax-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\MINT\MINT-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\MINT\MINT-Qt,strDataDir|{userappdata}\MINT\}');
  Result := True;
end;
