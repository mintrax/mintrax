...
def main():
    ...
    # Filter out hosts with multiple mintrax ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple mintrax ports' % (ip_stats(ips)), file=sys.stderr)
