...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='mintrax.conf'
CONFIGFOLDER='/root/.mintrax'
COIN_DAEMON='mintraxd'
COIN_CLI='mintrax-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/mintrax910/mintrax/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
