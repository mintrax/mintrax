Contributing to MINT Core
============================

The MINT Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/mintrax910/mintrax/blob/master/doc/translation_process.md)
...
The following applies to code changes to the MINT Core project, and is not to be
confused with overall MINT Network Protocol consensus changes.

Whether a pull request is merged into MINT Core rests with the project merge
...
Patches that change MINT consensus rules are considerably more involved than
...
Where a patchset proposes to change the MINT consensus, it must have been
...
The project leader is the release manager for each MINT Core release.
