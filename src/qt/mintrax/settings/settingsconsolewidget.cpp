...
#include "qt/mintrax/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/mintrax/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(MINTGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(CMD_REPLY, (tr("Welcome to the MINT RPC console.") + "<br>" +
