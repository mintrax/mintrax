...
#include "qt/mintrax/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/mintrax/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(MINTGUI* _window, QWidget *parent) :
