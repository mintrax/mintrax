...
#include "qt/mintrax/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(MINTGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &MINTGUI::openFAQ);
