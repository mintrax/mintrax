...
#include "qt/mintrax/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(MINTGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("MINT_tx_csv_export(*.csv)") : tr("MINT_addresses_csv_export(*.csv)"),
                                        nullptr);
