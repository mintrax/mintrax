...
#include "qt/mintrax/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/mintrax/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(MINTGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to MINTGUI::handleRestart()
