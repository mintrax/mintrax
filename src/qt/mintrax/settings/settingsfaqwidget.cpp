...
#include "qt/mintrax/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/mintrax/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(MINTGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableMINT,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableMINT,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableMINT,
    ...
    connect(ui->pushButton_UnspendableMINT, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableMINT);});
    ...
    if (parent)
        connect(parent, &MINTGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
