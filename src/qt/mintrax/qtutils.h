...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, MINTGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, MINTGUI* gui, double posX = 3);
