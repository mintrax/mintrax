...
#include "qt/mintrax/sendcustomfeedialog.h"
#include "qt/mintrax/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(MINTGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &MINTGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
