...
#include "qt/mintrax/forms/ui_masternodeswidget.h"

#include "qt/mintrax/qtutils.h"
#include "qt/mintrax/mnrow.h"
#include "qt/mintrax/mninfodialog.h"
#include "qt/mintrax/masternodewizarddialog.h"
...
#include "util.h"
#include "qt/mintrax/optionbutton.h"
#include <iostream>
#include <fstream>
...
MasterNodesWidget::MasterNodesWidget(MINTGUI *parent) :
    PWidget(parent),
    ...
    if (fs::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:30540 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
