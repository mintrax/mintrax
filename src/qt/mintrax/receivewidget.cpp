...
#include "qt/mintrax/forms/ui_receivewidget.h"
#include "qt/mintrax/requestdialog.h"
...
#include "qt/mintrax/addressholder.h"
...
ReceiveWidget::ReceiveWidget(MINTGUI* parent) :
    PWidget(parent),
