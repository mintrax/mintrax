...
#include "qt/mintrax/furabstractlistitemdelegate.h"
#include "qt/mintrax/furlistrow.h"
#include "transactiontablemodel.h"
#include "qt/mintrax/txviewholder.h"
...
#include "config/mintrax-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    explicit DashboardWidget(MINTGUI* _window);
    ~DashboardWidget();
