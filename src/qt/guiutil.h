...
/** Utility functions used by the MINT Qt UI.
 */
namespace GUIUtil
{
...
// Render MINT addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZbib = false);
...
// Parse "mintrax:" URI into recipient object, return true on successful parsing
