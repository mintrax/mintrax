...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(MINT);
    unitlist.append(mMINT);
    unitlist.append(uMINT);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    ...
    case MINT:
        return QString("MINT");
    case mMINT:
        return QString("mMINT");
    case uMINT:
        return QString::fromUtf8("uMINT");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZbib)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZMINT)
{
    QSettings settings;
...
QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZMINT)
{
