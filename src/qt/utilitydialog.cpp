...
#include "qt/mintrax/qtutils.cpp"
                                                                    ...
                                                                    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("MINT") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
/* On x86 add a bit specifier to the version so that users can distinguish between
    ...
    if (about) {
        ...
        licenseInfoHTML.replace(uri, "<a style='color: #CCB363;text-decoration:none'  href=\"\\1\">\\1</a>");
        ...
        QString header = tr("Usage:") + "\n" +
                         "  mintrax-qt [" + tr("command-line options") + "]                     " + "\n";
...
ShutdownWindow::ShutdownWindow(QWidget* parent, Qt::WindowFlags f) : QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("MINT is shutting down...") + "<br /><br />" +
