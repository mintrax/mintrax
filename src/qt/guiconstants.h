...
/* MINT GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "MINT"
#define QAPP_ORG_DOMAIN "mintrax.org"
#define QAPP_APP_NAME_DEFAULT "MINT-Qt"
#define QAPP_APP_NAME_TESTNET "MINT-Qt-testnet"
