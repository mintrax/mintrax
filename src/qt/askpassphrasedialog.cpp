...
#include "qt/mintrax/loadingdialog.h"
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            MINTGUI* window = static_cast<MINTGUI*>(parentWidget());
...
{
    MINTGUI* gui = static_cast<MINTGUI*>(parentWidget());
...
{
    hide();
    static_cast<MINTGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("MINT will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your MINTs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
