...
{
    if (nHeight > 1300000) return    650000 * COIN;
    if (nHeight > 1200000) return    650000 * COIN;
    if (nHeight > 1100000) return    650000 * COIN;
    if (nHeight > 1000000) return    650000 * COIN;
    if (nHeight >  950000) return    650000 * COIN;
    if (nHeight >  900000) return    650000 * COIN;
    if (nHeight >  800000) return    650000 * COIN;
    if (nHeight >  750000) return    650000 * COIN;
    if (nHeight >  700000) return    650000 * COIN;
    if (nHeight >  650000) return    550000 * COIN;
    if (nHeight >  600000) return    550000 * COIN;
    if (nHeight >  500000) return    450000 * COIN;
    if (nHeight >  400000) return    450000 * COIN;
    if (nHeight >  300000) return    450000 * COIN;
    if (nHeight >  200000) return    200000 * COIN;
    if (nHeight >  150000) return    200000 * COIN;
    if (nHeight >  100000) return    200000 * COIN;
    if (nHeight >   60000) return    100000 * COIN;
    if (nHeight >   50000) return    100000 * COIN;
    if (nHeight >   20000) return    40000 * COIN;
    if (nHeight >   10000) return    5000 * COIN;
    if (nHeight >     500) return    10 * COIN;
...
{
    if (nHeight > 1300000) return    250 * COIN;
    if (nHeight > 1200000) return    280 * COIN;
    if (nHeight > 1100000) return    300 * COIN;
    if (nHeight > 1000000) return    350 * COIN;
    if (nHeight >  950000) return    400 * COIN;
    if (nHeight >  900000) return    450 * COIN;
    if (nHeight >  800000) return    550 * COIN;
    if (nHeight >  750000) return    650 * COIN;
    if (nHeight >  700000) return    700 * COIN;
    if (nHeight >  650000) return    300 * COIN;
    if (nHeight >  600000) return    400 * COIN;
    if (nHeight >  500000) return    100 * COIN;
    if (nHeight >  400000) return    150 * COIN;
    if (nHeight >  300000) return    100 * COIN;
    if (nHeight >  200000) return    80 * COIN;
    if (nHeight >  150000) return    100 * COIN;
    if (nHeight >  100000) return    90 * COIN;
    if (nHeight >   60000) return    75 * COIN;
    if (nHeight >   50000) return    70 * COIN;
    if (nHeight >   20000) return    45 * COIN;
    if (nHeight >   10000) return    20 * COIN;
    if (nHeight >     500) return    1.2 * COIN;
...
{
    if (nHeight > 1300000) return    225 * COIN;
    if (nHeight > 1200000) return    230 * COIN;
    if (nHeight > 1100000) return    250 * COIN;
    if (nHeight > 1000000) return    300 * COIN;
    if (nHeight >  950000) return    350 * COIN;
    if (nHeight >  900000) return    400 * COIN;
    if (nHeight >  800000) return    500 * COIN;
    if (nHeight >  750000) return    600 * COIN;
    if (nHeight >  700000) return    650 * COIN;
    if (nHeight >  650000) return    250 * COIN;
    if (nHeight >  600000) return    350 * COIN;
    if (nHeight >  500000) return    90 * COIN;
    if (nHeight >  400000) return    140 * COIN;
    if (nHeight >  300000) return    90 * COIN;
    if (nHeight >  200000) return    70 * COIN;
    if (nHeight >  150000) return    90 * COIN;
    if (nHeight >  100000) return    80 * COIN;
    if (nHeight >   60000) return    65 * COIN;
    if (nHeight >   50000) return    60 * COIN;
    if (nHeight >   20000) return    35 * COIN;
    if (nHeight >   10000) return    15 * COIN;
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 MINT tx got MASTERNODE_MIN_CONFIRMATIONS
    uint256 hashBlock = UINT256_ZERO;
    CTransaction tx2;
    GetTransaction(vin.prevout.hash, tx2, hashBlock, true);
    BlockMap::iterator mi = mapBlockIndex.find(hashBlock);
    if (mi != mapBlockIndex.end() && (*mi).second) {
        CBlockIndex* pMNIndex = (*mi).second;                                                        // block for 1000 MINT tx -> 1 confirmation
