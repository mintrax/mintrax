...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MINT mintrax-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mintrax-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mintrax transaction") + "\n" +
                               "  mintrax-tx [options] -create [commands]   " + _("Create hex-encoded mintrax transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mintrax transaction
