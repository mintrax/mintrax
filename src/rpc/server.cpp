...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MINT features */
        {"mintrax", "listmasternodes", &listmasternodes, true },
        {"mintrax", "getmasternodecount", &getmasternodecount, true },
        {"mintrax", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"mintrax", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"mintrax", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"mintrax", "masternodecurrent", &masternodecurrent, true },
        {"mintrax", "startmasternode", &startmasternode, true },
        {"mintrax", "createmasternodekey", &createmasternodekey, true },
        {"mintrax", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"mintrax", "listmasternodeconf", &listmasternodeconf, true },
        {"mintrax", "getmasternodestatus", &getmasternodestatus, true },
        {"mintrax", "getmasternodewinners", &getmasternodewinners, true },
        {"mintrax", "getmasternodescores", &getmasternodescores, true },
        {"mintrax", "preparebudget", &preparebudget, true },
        {"mintrax", "submitbudget", &submitbudget, true },
        {"mintrax", "mnbudgetvote", &mnbudgetvote, true },
        {"mintrax", "getbudgetvotes", &getbudgetvotes, true },
        {"mintrax", "getnextsuperblock", &getnextsuperblock, true },
        {"mintrax", "getbudgetprojection", &getbudgetprojection, true },
        {"mintrax", "getbudgetinfo", &getbudgetinfo, true },
        {"mintrax", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"mintrax", "mnfinalbudget", &mnfinalbudget, true },
        {"mintrax", "checkbudgets", &checkbudgets, true },
        {"mintrax", "mnsync", &mnsync, true },
        {"mintrax", "spork", &spork, true },
...
{
    return "> mintrax-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:30545/\n";
}
