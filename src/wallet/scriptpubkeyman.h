...
#ifndef MINT_SCRIPTPUBKEYMAN_H
#define MINT_SCRIPTPUBKEYMAN_H
...
// see it on https://github.com/satoshilabs/slips/blob/master/slip-0044.md
static const uint32_t BIP32_HDCHAIN             = 0x348; 
